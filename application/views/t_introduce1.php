    ...
    <div class="wrapper-page">
        ...
        <div class="m-t-40 card-box">
            ...
            <div class="panel-body">
                <form class="am-form" action="teacher/up_introduce" method="post" enctype="multipart/form-data">
                    <div class="am-g">
                        ...
                        <div class="am-form-group ">
                            <button type="submit" class="am-btn am-btn-primary am-radius" style="width: 100%;height: 100%;">提交</button>
                        </div>
                    </div>
